...
class Builder implements BuilderInterface
{
    ...
    /**
     * @see  Lotos\DI\Builder\BuilderValidator
     */
    ...
    /**
     * @see Lotos\DI\Builder\BuilderInterface::build
     */
     ...
     *
     * @method getConstructorParameters подбирет с репозитория подходящие аргументы для конструктора
